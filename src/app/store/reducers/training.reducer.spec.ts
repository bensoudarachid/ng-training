...
describe('Training Reducer',()=>{
    it('should store training list', ()=>{
        ...
        const changedState = trainingsReducer(Map(initTrainingsState),loadTrainingsAction)
        expect(initTrainingsState.trainings.size ).toBeLessThan((List)(changedState.get('trainings')).size )
    })
})